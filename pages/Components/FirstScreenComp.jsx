            ...
            {show ?
                <Modal show={show} onHide={() => handleClose()} backdrop="static" keyboard={false} centered fullscreen={'lg-down'} size={'xl'}>
                    <Modal.Body className="px-5" style={{ paddingTop: "60px", paddingBottom: "60px" }}>
                        ...
                        <p className="text-secondary" style={{ fontSize: '22px' }}>We’ll help you get set up based on your business needs.</p>
            ...
            {show2 ?
                <Modal show={show2} backdrop="static" keyboard={false} centered fullscreen={'xl-down'} size={'xl'} animation={false}>
                    <Modal.Body className="px-5" style={{ paddingTop: "60px", paddingBottom: "60px" }}>
                        ...
                        <p className="text-secondary" style={{ fontSize: '20px' }}>Pick as many as you like – you can always change these later. We'll make sure you're set up to sell in these places.</p>
                        <div className="row w-100">
                                ...
                                <div className="px-4 pt-3" style={{ border: "1px solid #C9CCCF", borderRadius: "5px" }}>
                                    <div className="row">
                                        ...
                                        <div className="col-4 col-xl-3">
                                            <img src="https://shopify-assets.shopifycdn.com/shopifycloud/start-launch-web/assets/6b3415dfdf5aeb62668a7db7335a09c5.svg" alt="#ImgNotFound" />
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            {show3 ?
                <Modal show={show3} backdrop="static" keyboard={false} centered fullscreen={'xl-down'} size={'xl'} animation={false}>
                    <Modal.Body className="px-5" style={{ paddingTop: "60px", paddingBottom: "60px" }}>
                        ...
                        <p className="text-secondary" style={{ fontSize: '20px' }}>Choose all that apply, and we’ll make sure you’re set up to sell.</p>
                        <div className="row w-100">
                            <div className="col-lg-6 mt-3">
            ...
            {show4 ?
                <Modal show={show4} backdrop="static" keyboard={false} centered fullscreen={'xl-down'} size={'xl'} animation={false}>
                    <Modal.Body className="px-5" style={{ paddingTop: "60px", paddingBottom: "60px" }}>
                        ...
                        <p className="text-secondary" style={{ fontSize: '20px' }}>Pick the option that best fits your business right now. You can always change this later.</p>
                        <div className="row w-100">
                            <div className="col-lg-6 mt-3">
                                <div className="px-4 py-2" style={{ border: "1px solid #C9CCCF", borderRadius: "5px" }}>
                                    <div className="row">
