...
export default function FirstScreenComp() {
    ...
    return (
        <div>
            <Modal className="animationObject" show={AlwaysShow} onHide={() => handleClose()} backdrop="static" keyboard={false} centered fullscreen={'lg-down'} size={'xl'} animation={false}>
                <Modal.Body className="px-5" style={{ paddingTop: "60px", paddingBottom: "60px" }}>
                    ...
                    <ProgressBar variant="success" now={show ? 1 : <></> && show2 ? 30 : <></> && show3 ? 90 : <></> && show4 ? 90 : <></>} style={{ height: "10px" }} className='mt-4' />
                    {show ?
                        <>
